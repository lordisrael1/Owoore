...
/**
 * formatMoney.ts — display formatting for amounts in emails and dashboard.
 *
 * All amounts stored as kobo (integer) in DB and Nomba.
 * These functions convert to human-readable naira strings for UI output.
 */
